...
public class VideoAdapter extends BaseAdapter {  //BaseAdapter 추상 클래스 구체화
    ...
    public ArrayList<com.example.easydashcam.Video>arrayVideo;  // listView 보일 arrayVideo
    ...
    public VideoAdapter(Context mContext, ArrayList<com.example.easydashcam.Video>array_videos){    //변수 초기화를 위한 생성자
    ...
    public View getView(int position, View convertView, ViewGroup parent) { //listView연결을 위한 핵심 method
        ...
        intent_play=new Intent(context, com.example.easydashcam.playActivity.class);
